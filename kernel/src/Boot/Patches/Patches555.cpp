...
void Mira::Boot::Patches::install_prerunPatches_555()
{
	...
	kmem = (uint8_t *)&gKernelBase[0x00393EEB];
	kmem[0] = 0xEB;
  ...
  // Patch to remove vm_fault: fault on nofault entry, addr %llx
	...
	kmem = (uint8_t *)&gKernelBase[0x0002EE98];
	kmem[0] = 0x90;
	kmem[1] = 0x90;
	kmem[2] = 0x90;
	kmem[3] = 0x90;
	...
	kmem = (uint8_t *)&gKernelBase[0x050985E];
	kmem[0] = 0x00;
	kmem[1] = 0x00;
	kmem[2] = 0x00;
	kmem[3] = 0x00;

	kmem = (uint8_t *)&gKernelBase[0x050AB2C];
	kmem[0] = 0x00;
	kmem[1] = 0x00;
	kmem[2] = 0x00;
	kmem[3] = 0x00;
	...
	kmem = (uint8_t *)&gKernelBase[0x0011B264];
	kmem[0] = 0x90;
	kmem[1] = 0x90;
